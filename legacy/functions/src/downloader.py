...
class VideoDownloader:
    ...
    def _load_configuration_from_dict(self, config):
        ...
        self.csv_path = os.path.join(base_output_dir, safe_brand_name, f"{safe_brand_name}_discovered_videos.csv")
        video_folder_name = config.get('video_folder_name', 'video')
        self.output_dir = os.path.join(base_output_dir, safe_brand_name, video_folder_name)
