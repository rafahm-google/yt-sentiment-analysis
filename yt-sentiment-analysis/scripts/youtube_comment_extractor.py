...
class YouTubeCommentExtractor:
    ...
    def _load_configuration(self, config_path):
        ...
        self.input_csv_path = os.path.join('outputs', safe_brand_name, f"{safe_brand_name}_discovered_videos.csv")
        self.output_csv_path = os.path.join('outputs', safe_brand_name, f"{safe_brand_name}_raw_comments.csv")
