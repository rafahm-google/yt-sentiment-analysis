    ...
    def prepare_sources(self):
        ...
        if os.path.exists(self.videos_csv_path):
            try:
                ...
                cols_to_include = [c for c in ['title', 'channel', 'views', 'relevance_score', 'content_archetype', 'video_url'] if c in videos_df.columns]
        ...
        if os.path.exists(self.comments_csv_path):
            try:
                ...
                sample_comments = comments_df[cols].head(200) if not comments_df.empty else comments_df
